      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5 lg:gap-6 w-full">
        {projects.map((project, index) => (
          <a
            ...
            className="group relative overflow-hidden w-full min-h-[220px] sm:min-h-[250px] md:min-h-[270px] lg:min-h-[300px] rounded-2xl sm:rounded-3xl border border-neutral-200 bg-white p-4 sm:p-5 md:p-6 lg:p-7 flex flex-col transition-all duration-500 hover:-translate-y-1 sm:hover:-translate-y-2 hover:border-neutral-400 hover:shadow-[0_20px_60px_rgba(0,0,0,0.08)] before:absolute before:left-0 before:top-0 before:h-1 before:w-0 before:bg-red-400 before:transition-all before:duration-500 hover:before:w-full"
          >
